...
async function almprincipal(socket,alm,salida){
    try{
...
function consulta1(conexion,socket,alm,salida){ return new Promise((resolve,reject)=>local_provincia_registros1(resolve,reject,conexion,socket,alm,salida)) }

function consulta2(conexion,socket,alm,salida){ return new Promise((resolve,reject)=>local_provincia_registros2(resolve,reject,conexion,socket,alm,salida)) }

function consulta3(conexion,socket,alm,salida){ return new Promise((resolve,reject)=>local_provincia_registros3(resolve,reject,conexion,socket,alm,salida)) }
