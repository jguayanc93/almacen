...
async function almventanilla(socket,alm,salida){
    try{
...
function consulta1(conexion,socket,alm,salida){ return new Promise((resolve,reject)=>ventanilla_registros(resolve,reject,conexion,socket,alm,salida)) }

function consulta2(conexion,socket,alm,salida){ return new Promise((resolve,reject)=>ventanilla_registros2(resolve,reject,conexion,socket,alm,salida)) }

function consulta3(conexion,socket,alm,salida){ return new Promise((resolve,reject)=>ventanilla_registros3(resolve,reject,conexion,socket,alm,salida)) }
